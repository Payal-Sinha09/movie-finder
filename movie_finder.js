const API_URL="http://www.omdbapi.com/?i=tt3896198&apikey=c65c4080&s=";
const API_URL_SEARCH="http://www.omdbapi.com/?apikey=c65c4080&i=";
var search_input= document.getElementById("search-input");
var card=document.getElementsByClassName("movie-cards")[0];
document.getElementsByClassName("search")[0].addEventListener("click",function(){console.log(search_input.value);
